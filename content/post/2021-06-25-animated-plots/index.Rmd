...
wm <- data.table::fread("static/data/gwm_wm_ridgeplot_data.csv")
...
```{r wm}
# NIH EXAMINER working memory data - fill sample
wm <- data.table::fread("/Users/joey/blogdown.brainworkup/static/data/wm.csv")
...
```{r}
knitr::include_graphics("/Users/joey/blogdown.brainworkup/static/data/anim.gif")
```
<<<<<<< HEAD
=======

>>>>>>> c86f8e7a6abf7595982e08d21eb75dfc7f1bebc5
