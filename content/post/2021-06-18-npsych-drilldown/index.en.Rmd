...
patient <- "patient"
# path to files
data_path <- ("~/blogdown.brainworkup/content/post/2021-06-18-npsych-drilldown/csv")
...
```{r drillp, fig.cap='Drilldown Neuropsych Pct', echo=T, out.width="100%", out.height="100%"}
colors <-
  c(
    "#058DC7",
    "#50B432",
...
```{r drillz, fig.cap='Drilldown Neuropsych zScores', echo=T, out.width="100%", out.height="100%"}
colors <-
  c(
    "#058DC7",
    "#50B432",
