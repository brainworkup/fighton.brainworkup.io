...
#   Otherwise, set `projects = ["genomics"]`.
projects: []
output:
...
```{r embed-xaringan}
xaringanExtra::embed_xaringan(url = "https://brainworkup.org/2021/08/26/xaringan-drilldown/",
                              ratio = "4:3")
```

```{r xaringan-share-again}
xaringanExtra::use_share_again()
```

```{r style-share-again, echo=FALSE}
xaringanExtra::style_share_again(
  share_buttons = c("twitter", "linkedin", "instagram")
)
```

```{r xaringan-broadcast}
